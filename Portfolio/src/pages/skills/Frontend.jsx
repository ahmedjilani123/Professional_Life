...
const Frontend = (props) => {
  ...
  return (
    <>
       { tooltips == "sapui5" ? <div onClick={UrlHandlerFrontEnd} className='active:bg-slate-300 group  relative group cursor-pointer shadow-lg shadow-orange-600/50 w-[7rem] h-[5rem] rounded-md bg-gradient-to-r from-blue-500  to-orange-600 border border-orange-600  mt-6 flex justify-center items-center content-center'>
