...
const Tools = (props) => {
  ...
  return (
    ...
    <>
          ...
          <div className='mt-5 hover:scale-105 ease-out transiton duration-300 relative group cursor-pointer shadow-lg shadow-orange-600/50 w-[7rem] h-[5rem] rounded-full bg-gradient-to-r from-[#fac0a1]   to-orange-600 border border-orange-600  flex justify-center items-center content-center'>
