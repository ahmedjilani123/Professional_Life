...
eventFire ?(
  <div className='flex  justify-between mt-2  w-full rounded-lg'>
          <button className='bg-orange-600 text-custom-dark-blue w-full rounded-l-lg h-9 active:text-orange-500 active:bg-white'>Download CV</button>
          <button className='bg-custom-dark-blue text-orange-600 w-full rounded-r-lg h-9 border border-orange-600 active:bg-orange-500 active:text-white'>Hire Me</button>
      </div> 
) : (
